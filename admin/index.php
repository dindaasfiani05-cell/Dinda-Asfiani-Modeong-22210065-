                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="index" class="text-nowrap logo-img text-center d-block py-3 w-100">
                                    <img src="assets/images/baru1.png" alt="">
                                </a>
                                <p class="text-center">Mudah diakses, cepat, dan tepat untuk masyarakat. Jelajahi
                                    informasi wilayah dengan satu klik.</p>
                                <form action="auth/log_auth" method="POST">
                                    <div class="mb-3">
